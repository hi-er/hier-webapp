...
import{forgotPassword, login} from'../firebase/firebase'
import './login.css';
  ...
  function back(){
    ...
    <div className="simple-login-container">
        ...
        <div className="row textCenter">
            <div className="col-md-12 form-group">
                <input type="submit" onClick={tryLogin} className="btn btn-block btn-login" value="Send Link" />
            </div>
            <div className="col-md-12 form-group">
                <input type="submit" onClick={back} className="btn btn-block btn-login" value="back" />
            </div>
        </div>
